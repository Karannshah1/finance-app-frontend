...
const RetrieveText = () => {
    ...
    const handleRetrieve = async () => {
        ...
        try {
            ...
            setError('Failed to retrieve text. The number might not exist.');
            console.error(err);
        } finally {
            setIsLoading(false);
        }
    ...
    // This function replaces the old CopyToClipboard library
    const handleCopy = () => {
        if (text) {
        ...
        <div className="card">
            ...
            <div className="input-group">
                ...
                <button onClick={handleRetrieve} disabled={isLoading}>
                    {isLoading ? 'Loading...' : 'Retrieve Text'}
                </button>
            </div>
            {error && <p className="error">{error}</p>}
            {text && (
                <div className="retrieved-text-container">
                    <pre className="retrieved-text">{text}</pre>
                    {/* A simple button that calls our new handleCopy function */}
